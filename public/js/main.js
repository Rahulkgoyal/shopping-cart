...
var JUICE=[
    {name:'Juice1',price:20},
    {name:'Juice2',price:50},
    {name:'Juice3',price:45}
];

var SALAD=[
    {name:'Salad1',price:35},
    {name:'salad2',price:45},
    {name:'salad3',price:20}
];
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center"> 
                        <div class="btn-group">
                            ...
                            class="btn btn-sm btn-outline-secondry"> <a
                            ...
                            class="btn btn-sm btn-outline-secondry">Add to cart</button>
                        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center"> 
                        <div class="btn-group">
                            ...
                            class="btn btn-sm btn-outline-secondry"> <a href="/cart"
